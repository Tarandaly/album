          ...
          <div class="col-12 col-lg-7">
              <div class="row gy-50">
                  ...
                  <div class="col-6 col-md-4">
                      ...
                      <ul class="nav flex-column text-white nav-opacity nav-gap-sm">
                          <li class="nav-item"><a class="nav-link" href="tel:12023580309">+1 202-358-0309</a></li>
                          <li class="nav-item"><a class="nav-link" href="tel:12023580408">+1 202-358-0408</a></li>
                          <li class="nav-item"><a class="nav-link" href="mailto:hello@startbox.com">hello@startbox.com</a></li>
                      </ul>
                  </div>
              </div>
          </div>
